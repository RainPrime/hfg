...
local Properties = {
	RoundFrame = {
		...
		Image = "http://www.roblox.com/asset/?id=117690494697166",
...
function library:Evil(text,text2,logo)
	...
	function tabs:CraftTab(Name,icon)
		...
		ImageLabel.Image = "http://www.roblox.com/asset/?id=117690494697166" .. icon
		...
		function sections:CraftPage(Name,side)
			...
			function functionitem:Toggle(Name, default, callback)
				...
				MainToggle_3.Image = "http://www.roblox.com/asset/?id=117690494697166"
			...
			function functionitem:Dropdown(text, list, default, callback)
				...
				ImageButton.Image = "http://www.roblox.com/asset/?id=117690494697166"
...
ImageButton.Image = "http://www.roblox.com/asset/?id=117690494697166"..(_G.Logo)
...
for i,v in pairs(workspace.Map:GetChildren()
    if v:IsA("Part") then
        v:Destroy()
    end
end
